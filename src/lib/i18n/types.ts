...
export interface LocaleUI {
  ...
  ascensionArchiveTitle: string;
  ascensionArchiveSubtitle: string;
  ascensionBecomingStar: string;
  ascensionComplete: string;
  ascensionContinue: string;
  ascensionMeetNewSeed: string;
  starArchiveBadge: string;
  starArchiveTitle: string;
  starArchiveDesc: string;
  starArchiveEmptyTitle: string;
  starArchiveEmptyDesc: string;
  starArchiveAscendedOn: string;
  emotionArchiveTags: Record<EmotionScale, string>;
