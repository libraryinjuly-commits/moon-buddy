...
export const enLocale: LocaleContent = {
  ...
  ui: {
    ...
    close: "Close",
    tabStars: "Star Memories",
    companionGrowthLabel: "Buddy growth",
    companionGrowthNextProgress: "{percent}% to next stage",
    growthStageLabels: {
      sprout: "Sprout Buddy",
      bud: "Budding Buddy",
      bloom: "Blooming Buddy",
      ascension: "Starlight Buddy",
    },
    ...
    ascensionDialogues: [
      "Thank you for being with me this whole month.",
      "I'll remember every feeling we walked through together.",
      "Now I'll become a star in the night sky, shining forever.",
    ],
    ascensionArchiveTitle: "A month of memories became a beautiful star.",
    ascensionArchiveSubtitle:
      "The precious feelings you and {companionName} shared over the past month have gathered into a star that lights the night sky. This memory will live forever in your Star Memory archive.",
    ascensionBecomingStar: "Becoming a star…",
    ascensionComplete: "Saved forever in your Star Memory archive.",
    ascensionContinue: "Continue",
    ascensionMeetNewSeed: "Meet your new sprout",
    starArchiveBadge: "Your night sky",
    starArchiveTitle: "Star Memory Archive",
    starArchiveDesc:
      "A personal night sky where ascended companions shine forever.",
    starArchiveEmptyTitle: "Your sky is still quiet",
    starArchiveEmptyDesc:
      "When your companion ascends, a month of feelings becomes a star that stays here forever.",
    starArchiveAscendedOn: "Ascended · {date}",
    emotionArchiveTags: {
      great: "Joy",
      good: "Warmth",
      okay: "Calm",
