...
export const enLocale: LocaleContent = {
  ...
  ui: {
    ...
    dayUnit: "day",
    daysCountUnit: " days",
    daysUntilPeriod: "About until next rest phase:",
    ...
    moodFeedTitle: "Share today's feeling",
  ...
  phaseLabels: {
    menstrual: "Restful phase",
    follicular: "Renewing phase",
    ovulation: "Bright energy phase",
    luteal: "Sensitive phase",
  },
  rhythmPhaseBrief: {
    default: "Start recording your rhythm. {companionName} will be right here.",
    menstrual: "A restful phase. {companionName} will stay close.",
    follicular: "Energy is returning. Share how you feel today.",
    ovulation: "Your energy shines brightly today.",
    luteal: "You may feel a little sensitive. {companionName} is here with you.",
  },
  moodLabels: {
    great: "Great",
    good: "Good",
