...
export const enLocale: LocaleContent = {
  language: "EN",
  ui: {
    slogan: "A little moon friend that grows with your records",
    loading: "Loading Moon Buddy...",
    languageLabel: "Language",
    setupTitle: "Get Started",
    setupDesc: "Add your info and choose a name for your moon buddy.",
    myName: "My Name",
    ...
    shareSystem: "Share to other apps",
    shareKakaoUnavailable: "KakaoTalk sharing is unavailable.",
    shareKakaoFailed: "KakaoTalk share failed. Please try again.",
    shareCopyFailed: "Failed to copy the link.",
    shareSystemUnavailable: "System share is not supported on this device.",
    shareSystemFailed: "Share failed. Please try again.",
    ...
    dayUnit: "day",
    daysCountUnit: " days",
    daysUntilPeriod: "About until next period:",
    moonAdvice: "Moon's Personalized Advice",
    conditionGuide: "Today's Condition Guide",
    moodTag: "Mood",
    growthRecord: "Growth Record",
    currentEpithet: "Current Epithet",
    moodLogs: "Mood Logs",
    nextEpithet: "Next Epithet",
    maxEpithet: "Max epithet achieved! You're fully in sync with {name} ✨",
    ...
    insightsTabDesc: "Cycle data and personalized advice in one place.",
    ...
    profileReportTitle: "Analytics Report",
    ...
    close: "Close",
    tabStars: "Stars",
    companionGrowthLabel: "Growing together",
    companionStages: {
      seed: "Seed",
      sprout: "Sprout",
      young: "Young Companion",
