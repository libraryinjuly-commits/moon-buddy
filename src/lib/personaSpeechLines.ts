...
const KO_SJ: BuddySpeechLines = {
  menstrual: [
    "주인님, 생리 구간 확인됐습니다. 오늘 행동 지침: 수분 섭취, 가벼운 휴식, 과로 금지.",
  ...
  onPeriod: [
    "생리 중 — 오늘은 속도를 반드시 줄이세요. {characterName}가 경계합니다.",
    "찜질팩, 이불, 따뜻한 음료. 편안한 환경을 우선 확보하세요.",
    "통증이 있으면 휴식이 정답입니다. 제가 옆에 있을게요.",
  ],
  default: [
    "주기 기록을 시작하면 {characterName}가 맞춤 안내를 드릴 수 있어요.",
    "기분 버튼으로 오늘 상태를 알려 주세요. 기록이 곧 보호입니다.",
    "완벽하지 않아도 괜찮습니다. 꾸준함이 가장 중요해요.",
  ],
  comfort: [
...
const KO_SP: BuddySpeechLines = {
  menstrual: [
    ...
    "생리 중엔 속도 줄이는 게 대박 현명한 선택이야. 오늘은 느긋하게 가자!",
  ...
  onPeriod: [
    "생리 중! 오늘은 슬로우 모드 ON! {characterName}랑 편하게 쉬자 🤍",
    "찜질팩+포근한 이불=필수템. 지금 필요한 건 휴식이야!",
    "아프면 더 쉬어도 돼. 오늘은 주인님이 주인공!",
  ],
  default: [
    "기록 시작하면 {characterName}가 더 재밌는 이야기 해줄 수 있어! 같이 해볼래?",
    "기분 버튼 눌러봐! 지금 마음이 궁금해!",
    "완벽 안 해도 돼. 조금씩만 같이 가자!",
  ],
  comfort: [
    "오늘 힘들었으면 그만큼 대단한 거야! {characterName}가 응원 중!",
    "쉬는 것도 실력이야. 오늘은 휴식이 정답!",
    "남이랑 비교 NO! 주인님 속도가 최고 속도!",
    "물 한 잔 마시고 쉬자. 이것만으로도 충분해!",
    "내일 걱정은 내일! 오늘은 나랑 놀자… 아니, 쉬자!",
  ],
};
